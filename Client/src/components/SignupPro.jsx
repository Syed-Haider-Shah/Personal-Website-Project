...
export default function SignupPro() {
  ...
  const submit = async (e) => {
    ...
    try {
      if (formData.password != formData.cpassword) {
        ...
        await axios
          .post("https://reno-pilots-back-end.vercel.app:8000/signuppro", {
            formData,
            postcode,
            choice,
  ...
  return (
    <div className="">
      <form action="POST" method="/signuppro" onSubmit={submit}>
          ...
          <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col mt-10 md:mt-0 relative z-10 shadow-md">
            ...
            <div>
              <p className="text-base mt-3">
                Do you want to contribute to the Inspration & DIY pages?{" "}
              </p>
              <Link className="text-base text-blue-700 mt-3" to={"/signupcon"}>
